...
import com.bwei.newhan.Tencent.Util;
import com.bwei.newhan.adapter.MyAdapter;
...
public class FragmentTwo extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        but_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(),"分享了！！！",Toast.LENGTH_LONG).show();
                shareToQzone();
            }
        });
    }
    ...
    private class BaseUIlistener implements IUiListener{
        ...
        public void onComplete(Object o) {
            ...
            me_imageView.setImageResource(R.mipmap.oliver);
            me_textView.setText("Oliver");
